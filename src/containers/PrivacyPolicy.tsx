...
const PrivacyPolicy: React.FC = () => {
  useEffect(() => {
    document.title = "LiftRight - Privacy Policy";
  }, []);
  return (
      ...
      <section className="mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center gap-12 md:px-8 flex-1">
        ...
        <div className="w-full flex justify-center mb-14">
          <div className="w-4/5 md:w-2/3 flex flex-col gap-5">
            <p className="text-right">Last updated: March 26, 2024</p>
            <p>
            ...
            <ul className="list-disc pl-3">
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to LiftRight AI.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to LiftRight AI, accessible
                  from{" "}
                  <a
                    href="https://www.liftrightai.com"
            ...
            <h4>Payment Data</h4>
            <p>
              LiftRight AI does not handle any payment information or payment
              ...
              subject to that third-party&apos;s terms and policies and any
              issues that arise should be directed to them.
            </p>
            <h4>Video Data</h4>
            <p>
              LiftRight AI may store uploaded videos in secure third-party
              databases to retrieve for users when viewing their responses.
              These will only private databases only viewable to the users who
            ...
            <p>
              The Company allows You to create an account and may allow you to
            ...
            <ul className="list-disc pl-3">
              <li>By email: info@liftrightai.com</li>
            </ul>
          </div>
        </div>
      </section>
