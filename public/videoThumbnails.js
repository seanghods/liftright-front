(function (window, document, undefined) {
  ...
  VideoThumbnails.prototype = {
    ...
    capture(file) {
      ...
      // Create video element without jQuery
      ...
      videoHtml.style.width = "600px"; // Set width as direct style
      videoHtml.src = fileURL;

      // Create source element and append to video
      var theVideo = document.createElement("source");
      theVideo.src = fileURL;
      theVideo.type = file.type;
      videoHtml.appendChild(theVideo);

      // Append video element to the body or a specific container if needed
    ...
    initScreenshot() {
      ...
      if (this.thumbWidth > this.thumbHeight) {
        ...
        this.thumbHeight = parseInt(this.thumbHeight * ratio, 10);
        ...
        this.thumbHeight = this.opts.maxHeight;
        this.thumbWidth = parseInt(this.thumbWidth * ratio, 10);
      }

      // Setting width and height using CSS styles
      this.videoHtml.style.width = this.thumbWidth + "px";
      this.videoHtml.style.height = this.thumbHeight + "px";
     ...
     */
    cleanUp() {
      if (this.videoHtml && this.videoHtml.parentNode) {
        this.videoHtml.parentNode.removeChild(this.videoHtml);
      }
      this.video = null;
      this.videoHtml = null;
    },
